...
export interface Campaign {
  ...
  open_count: number; click_count: number; created_at: string; sent_at: string | null;
}

export interface Contact {
  id: string; user_id: string; email: string;
  first_name: string | null; last_name: string | null;
  company: string | null; custom_fields: Record<string, string>; created_at: string;
}

export interface CampaignRecipient {
  id: string; campaign_id: string; contact_id: string; email: string;
  status: RecipientStatus; tracking_id: string;
  sent_at: string | null; opened_at: string | null;
  clicked_at: string | null; gmail_message_id: string | null;
}
